...
<span class="copyright">Copyright &copy; 2018.Wind Punish安全实验室 All rights reserved.</span>
</div>
...
<?php
	...
	if(isset($_POST['submit']) && $_POST['submit'])
	{
		...
		$ipwd2=md5(sha1($_POST["ipassword2"]));
			if ($iadmin == "" || $ipwd1 == "" || $ipwd2 == "") {
			echo'<p class="shake">请不要填写空值！</p>';	
			}
			else{
				if ($ipwd1==$ipwd2) {
				$isql="update admin set username='$iadmin',password='$ipwd1' where id='1'";
